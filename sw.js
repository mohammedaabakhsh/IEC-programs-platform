const CACHE='iec-platform-v2.3.0-mobile-app';
const ASSETS=['./','./index.html','./styles.css','./evaluation-v2.css','./app.js','./evaluation-v2.js','./cloud-sync.js','./question-bank.js','./question-bank.css','./program-features.js','./program-features.css','./advanced-features.js','./advanced-features.css','./completion-features.js','./completion-features.css','./insights-reports.js','./insights-reports.css','./launch-features.js','./launch-features.css','./strategic-suite.js','./strategic-suite.css','./mobile.css','./mobile.js','./manifest.webmanifest','./icon.svg'];
